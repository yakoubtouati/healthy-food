...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordHasherInterface $userPasswordHasher, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->emailVerifier->sendEmailConfirmation('visitor.registration.verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('healthy-food@gmail.com', 'Healthy Food'))
                    ->to($user->getEmail())
                    ->subject('validation du compte par email sur healthy-food')
    ...
    #[Route('/waiting/verify/email', name: 'visitor.registration.verify_email.waiting',methods:['GET'])]
    public function waiting():Response
    {

        return $this->render('pages/visitor/registration/waiting_verif_email.html.twig');
    }
